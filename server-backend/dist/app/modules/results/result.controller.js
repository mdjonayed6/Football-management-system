...
//     }
// }
const createMatchResult = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { match_id, home_team_score, away_team_score, winner_team_id } = req.body;
    const existingMatchId = yield queryCollection_1.Query.executeQuery(`SELECT * FROM matches WHERE match_id ='${match_id}'`);
    if (existingMatchId.length == 0) {
        res.status(404).send({
            success: false,
            message: 'Match id does not exist',
    ...
    if (winner_team_id !== '0') {
        const existingWinnerTeam = yield queryCollection_1.Query.executeQuery(`SELECT * FROM teams WHERE team_id ='${winner_team_id}'`);
...
//Get All Results
const getAllResults = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const getResultsInformation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateResultInformation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteResultInformation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const result = yield queryCollection_1.Query.executeQuery(`DELETE FROM match_results WHERE result_id ='${id}'`);
        if (result) {
            res.status(200).send({
                success: true,
...
const matchResultRanking = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const query = `
    SELECT
    t.team_id,
    t.team_name,
