...
const createPlayer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const playerExistsResult = yield queryCollection_1.Query.executeQuery(playerExistsQuery);
    ...
    const positionExistsResult = yield queryCollection_1.Query.executeQuery(positionExistsQuery);
    ...
    const actualExistsResult = yield queryCollection_1.Query.executeQuery(actualExistsQuery);
...
const getAllPlayers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const playersResult = yield queryCollection_1.Query.executeQuery(query);
        ...
        const totalPlayers = ((_a = countResult[0]) === null || _a === void 0 ? void 0 : _a.total) || 0; // Extract total count from the result
        res.status(200).json({
            success: true,
...
const updatePlayerInformation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const deletePlayerInformation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const result = yield queryCollection_1.Query.executeQuery(`DELETE FROM players WHERE player_id ='${id}'`);
        if (result) {
            res.status(200).send({
                success: true,
...
const playerForCoach = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const searchPlayers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const countResult = yield queryCollection_1.Query.executeQuery(countQuery);
        const totalPlayers = ((_b = countResult[0]) === null || _b === void 0 ? void 0 : _b.total) || 0; // Extract total count from the result
        res.status(200).json({
            success: true,
...
// MyTeamsPlayers
const myTeamPlayers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
